...
namespace BCPrice_Catcher
{
    public partial class Form4 : Form
    {
        ...
        private static int _strategyControlsCount = 0;
        ...
        private static TimerList _strategyTimerList = new TimerList();
        ...
        {
            int strategyControlId = _strategyControlsCount;
            ...
            btnStart.Tag = strategyControlId;
        ...
        {
            int strategyId = _strategyControlsCount - 1;
...
//            double tradeAmount = Convert.ToDouble(nudTradeAmount.Value);
        ...
        private void RemoveStrategy()
        {
            ...
            int strategyId = _strategies.Count - 1;
            var timer = _strategyTimerList.Timers[strategyId.ToString()];
            _strategyTimerList.Timers.Remove(strategyId.ToString());
            timer.Dispose();
