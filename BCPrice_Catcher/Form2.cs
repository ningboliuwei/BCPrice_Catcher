...
//                                  new HuobiTrader().GetAccountInfo().AvailableCny;
        ...
        {
            txtResult.Text =
                new BtccTrader().BuyMarket(Convert.ToDouble(txtAmount.Text), Trader.Trader.CoinType.Btc).ToString();
        }
        ...
        {
            txtResult.Text =
                new BtccTrader().SellMarket(Convert.ToDouble(txtAmount.Text), Trader.Trader.CoinType.Btc).ToString();
        }
...
//            MessageBox.Show(new BtccTrader().GetOrder(Convert.ToInt32(txtOrderId.Text), Trader.Trader.CoinType.Btc);
        ...
        {
            txtResult.Text =
                new HuobiTrader().CancelPlacedOrder(Convert.ToInt32(txtOrderId.Text), Trader.Trader.CoinType.Btc)
                    .ToString();
        }
    }
}